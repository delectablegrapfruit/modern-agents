/// SplitMix64: small, fast, and the same sequence on every platform, so a seed names one stage everywhere and a
/// saved fight carries on exactly as it would have.
