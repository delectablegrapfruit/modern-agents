...
| Press and hold on a playing video | Plays at 2× until you let go, with a speed badge at the top of the video (as on YouTube; not applied there, where it is native). Scroll sideways while holding to change the speed, 0.25× to 4×; every hold starts at 2× again. |
