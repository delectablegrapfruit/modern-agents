...
(function (root) {
  ...
  const PALETTES = {
    ...
    assembly: { name: 'Assembly Line', price: 0, reward: 'Reach Tetrominoes in the factory', colors: ['#000', '#f2c14e', '#f78154', '#4d9078', '#b4436c', '#5fad56', '#2e86ab', '#f2a541', '#3d4451', '#e0a458', '#8bb174', '#5b8e7d', '#a1869e', '#d1495b', '#8d99ae', '#edf2f4'] },
  ...
  const SKINS = {
    ...
    steel:   { name: 'Steel', price: 0, reward: 'Retool the factory once' },
  };
  ...
  const FRAMES = {
    ...
    hazard:   { name: 'Hazard Tape', price: 0, reward: 'Reach Hexominoes in the factory' },
  };
  ...
  const BACKDROPS = {
    ...
    belt:      { name: 'Conveyor', price: 0, reward: 'Pull 250 defects off the belt by hand' },
  };
